...
impl CodebaseScanner {
    pub fn new(scan_path: &std::path::Path, ignore_patterns: Vec<String>, supported_extensions: Vec<String>) -> Self {
        Self {
            scanner: Arc::new(CodeScanner::new(scan_path, ignore_patterns, supported_extensions)),
        }
    }
